        ...
        >
          ...
          >
            ...
            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
              <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
                <View style={{ backgroundColor: "#7C3AED18", borderRadius: 10, padding: 8 }}>
          ...
          {routeLoading ? (
            ...
            <View style={{ height: 340, marginHorizontal: 0, position: "relative" }}>
              <TripRouteMapView
                start={startCoord}
                end={endCoord}
              ...
              >
                ...
                >
                  ...
                  <View>
                    <Text style={{ fontSize: 10, fontFamily: "Inter_500Medium", color: "#6B7280" }}>START</Text>
                    <Text style={{ fontSize: 12, fontFamily: "Inter_700Bold", color: "#111827" }}>{fmtTime(trip.startTime)}</Text>
                  </View>
                </View>
                <View
                  style={{
                ...
                >
                  ...
                  <View>
                    <Text style={{ fontSize: 10, fontFamily: "Inter_500Medium", color: "#6B7280" }}>END</Text>
                    <Text style={{ fontSize: 12, fontFamily: "Inter_700Bold", color: "#111827" }}>{fmtTime(trip.endTime)}</Text>
                  </View>
                </View>
              </View>
            </View>
          ) : (
            <View style={{ paddingVertical: 40, paddingHorizontal: 20, alignItems: "center", gap: 10 }}>
          ...
          <View style={{ paddingHorizontal: 20, marginTop: 12, flexDirection: "row", gap: 10 }}>
            ...
            >
              ...
              <Text style={{ fontSize: 17, fontFamily: "Inter_700Bold", color: "#7C3AED" }}>
                {trip.distanceKm != null ? `${trip.distanceKm.toFixed(1)} km` : "—"}
              </Text>
              <Text style={{ fontSize: 11, fontFamily: "Inter_400Regular", color: colors.mutedForeground }}>Distance</Text>
            </View>
            <View
              style={{
                flex: 1,
            ...
            >
              ...
              <Text style={{ fontSize: 17, fontFamily: "Inter_700Bold", color: colors.primary }}>
                {(() => {
              ...
              <Text style={{ fontSize: 11, fontFamily: "Inter_400Regular", color: colors.mutedForeground }}>Duration</Text>
            </View>
          </View>
        </View>
      </View>
