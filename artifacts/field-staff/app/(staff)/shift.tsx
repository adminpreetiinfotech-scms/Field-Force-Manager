...
function DailyReportModal({ visible, onClose, userId, todayKm, trips, myAttendance, organization }: DailyReportModalProps) {
  const colors = useColors();
  const insets = useSafeAreaInsets();
  ...
  const buildReportText = () => {
    ...
    if (orgLine) lines.push(`🏢 Training Center: ${orgLine}`);
